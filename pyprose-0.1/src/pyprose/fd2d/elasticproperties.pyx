...
cpdef addpmls(int n1, int n2, int npml, np.ndarray[DTYPE_f, ndim=2] mod):
    """
...
cpdef buoyancy(int n1, int n2, np.ndarray[DTYPE_f, ndim=2] modro):
    """
...
cpdef lame(int n1, int n2, np.ndarray[DTYPE_f, ndim=2] modvp, np.ndarray[DTYPE_f, ndim=2] modvs, np.ndarray[DTYPE_f, ndim=2] modro):
    """
...
cpdef pmlgrids(int n1, int n2, float dh, int isurf, int npml, int ppml, float apml):
    """
