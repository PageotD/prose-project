...
cpdef cacqpos(int n1, int n2, float dh, int npml, np.ndarray[DTYPE_f, ndim=2] acq):
    """
...
cpdef cricker(int nt, float dt, float f0, float t0):
    """
...
cpdef csrcspread(int n1, int n2, float dh, int npml, float xs, float zs, float sigma):
    """
